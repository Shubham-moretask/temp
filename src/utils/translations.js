...
export const translations = {
  navbar: {
    phoneNumber: {
      English: '+919810431272',
      हिंदी: '+919810431272'
    },
    callText: {
      English: 'Call on this number to place an order',
      हिंदी: 'ऑर्डर देने के लिए इस नंबर पर कॉल करें'
    }
  },
  hero: {
    title: {
    ...
    phoneLabel: {
      ...
      हिंदी: 'अपना फ़ोन नंबर दर्ज करें'
    },
    ctaButton: {
    ...
    booking: {
      English: 'Booking...',
      हिंदी: 'बुकिंग हो रही है...'
    },
    validationError: {
      English: 'Please enter a valid 10-digit phone number.',
      हिंदी: 'कृपया एक वैध 10-अंकीय फ़ोन नंबर दर्ज करें।'
    },
    successMessage: {
      English: "Thanks! We'll contact you soon.",
      हिंदी: 'धन्यवाद! हम जल्द ही आपसे संपर्क करेंगे।'
    },
    errorMessage: {
      English: 'Something went wrong. Please try again.',
      हिंदी: 'कुछ गलत हो गया। कृपया पुनः प्रयास करें।'
    }
  },
  products: {
    sectionTitle: {
  ...
  combo: {
    ...
    subtitle: {
      English: 'Use the full range together for faster and long-lasting results.',
      हिंदी: 'तेज़ और लंबे समय तक चलने वाले परिणामों के लिए पूर्ण श्रृंखला का एक साथ उपयोग करें।'
    },
    products: {
      hairOil: {
        English: 'Hair Oil',
  ...
  howToUse: {
    ...
    steps: {
      oil: {
        title: {
          English: 'Oil Massage (3x a week)',
          हिंदी: 'तेल मालिश (सप्ताह में 3 बार)'
        },
        description: {
  ...
  consultation: {
    ...
    nameError: {
      ...
      हिंदी: 'कृपया अपना पूरा नाम दर्ज करें।'
    },
    phoneError: {
      English: 'Please enter a valid phone number.',
      हिंदी: 'कृपया एक वैध फ़ोन नंबर दर्ज करें।'
    },
    successMessage: {
      English: "Thanks! We'll call you shortly.",
      हिंदी: 'धन्यवाद! हम जल्द ही आपको कॉल करेंगे।'
    },
    errorMessage: {
      English: 'Something went wrong. Please try again.',
      हिंदी: 'कुछ गलत हो गया। कृपया पुनः प्रयास करें।'
  ...
  faq: {
    ...
    questions: {
      ...
      safe: {
        question: {
          English: 'Is it safe for all hair types?',
